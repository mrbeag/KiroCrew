...
live control-plane + optional tools/list; POST /verify is the same
snapshot with a distinct SEL verb; POST /sync asks the Gateway to
refresh one DEFAULT target.
