...
def bootstrap_context(cfg: "KiroCrewConfig") -> PlatformContext:
    ...
    # no-op (the public harnesses are baseline registry entries), so this is a
    # no-op for the public edition; the Amazon companion re-registers a Claude
    # backend through the dormant ACP_BACKEND_CLAUDE seam here. Best-effort — a
